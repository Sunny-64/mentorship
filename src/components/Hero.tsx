        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-8">
              <button className="hover:cursor-pointer bg-gradient-to-r from-slate-600 to-blue-600 text-white px-4 py-4 rounded-xl text-lg font-semibold hover:from-slate-700 hover:to-blue-700 transition-all duration-300 shadow-lg hover:shadow-xl flex items-center justify-center">
                Book Free Session
                <Calendar className="ml-2 w-5 h-5" />
              </button>
              <button className="hover:cursor-pointer  bg-white text-gray-900 px-8 py-4 rounded-xl text-lg font-semibold border-2 border-gray-200 hover:border-slate-300 hover:bg-slate-50 transition-all duration-300 shadow-md hover:shadow-lg flex items-center justify-center">
                Get Resume Reviewed
