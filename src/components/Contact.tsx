      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <a href="mailto:meeta.mentor@gmail.com" className="text-slate-600 hover:text-slate-700 font-medium">
          ...
          <div className="bg-gradient-to-br from-slate-50 to-blue-50 p-8 rounded-2xl shadow-lg border border-slate-200">
            ...
            <div className="mt-8">
              <button className="w-full bg-gradient-to-r from-slate-600 to-blue-600 text-white py-4 rounded-xl text-lg font-semibold hover:from-slate-700 hover:to-blue-700 transition-all duration-300 shadow-lg hover:shadow-xl">
                Send Email Now
              </button>
            </div>
          </div>
