      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <button className="bg-gradient-to-r from-slate-600 to-blue-600 text-white px-6 py-2.5 rounded-lg hover:cursor-pointer hover:from-slate-700 hover:to-blue-700 transition-all duration-300 shadow-md hover:shadow-lg font-medium">
              Book Free Session
            </button>
          </div>
        </div>
